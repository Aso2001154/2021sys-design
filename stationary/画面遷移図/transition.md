...
更新失敗ページ --> トップページ : トップへ
トップページ -left-> ジャンルページ : ジャンルをクリック
ジャンルページ --> 商品詳細 : 商品をクリック
商品詳細 --> カート : カートに入れるをクリック
商品詳細 --> トップページ : カートをクリック
商品詳細 : do/商品説明を表示
トップページ --> ランキングページ : ランキングをクリック
ジャンルページ --> ランキングページ : ランキングをクリック
検索結果ページ --> ランキングページ
ランキングページ --> トップページ : ジャンルをクリック
ランキングページ --> ジャンルページ : ジャンルをクリック
