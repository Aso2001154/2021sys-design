...
if($flg==0) { // flgが0の場合は住所が見つかった
    echo '<form action="management_signup_in.php" method="post">';
    ...
    echo '<p style="text-align: center;"><a href="management_signup_in.php" style="border-bottom: 1px solid black;">戻る</a></p>';
}
?>
</body>
</html>
